    ...
    return(
        <FooterContainer className="footer-container" id='footer-container'>
            ...
            <FooterMainColumn id="footer-main-column">
                ...
                {/* <Link className="home" href="/" id="link">
                    <Image src="CroppedSkoloLogo2.png" alt="Skolo" id="skolo-image" />
                </Link> */}
            ...
            <FooterMainColumn id="footer-main-column">
                <Explore id="explore">
                <FooterTitles className="ft-title">Explore</FooterTitles>
                <Link href="/">Home</Link>
            ...
            <FooterMainColumn id="footer-main-column">
                ...
                <FooterTitles className="ft-title">Contact</FooterTitles>
                <a id="email-link" href='brianmillarsd@gmail.com'>brianmillarsd@gmail.com</a>
                </Contact>
            </FooterMainColumn>

            <FooterMainColumn id="footer-main-column">
                <FooterTitles className="ft-title">Stay Updated</FooterTitles>
